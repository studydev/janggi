...
- Codex / ChatGPT Plus: 한도 1회 소진 및 사용량 재설정 후 후속 연속 요청 시 42% 잔여. 각 윈도우를 100%에서 시작해 이 작업만 사용했다고 가정할 때 1.58개 윈도우입니다. 확정 소진율은 아닙니다.
...
- Sol Fast는 다른 작업 폴더에서 새로 구현해 결과물만 옮겨 왔고, Astra는 인접 엔진·테스트 참고 이력이 있습니다. 완전 독립 신규 개발 간 성능 순위로 단정하지 않습니다.
