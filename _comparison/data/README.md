...
| [luna](make-ghcp-luna.md) | GPT-5.6 luna (MAX 1M) | 48분 39초 | 65.3 | 201 | 48 | 4,331 | 2,135 |
...
| [sol-fast](make-ghcp-sol-fast.md) | GPT-5.6 Sol Fast (MAX 1M) | 36분 31초 | 1,825.8 | 150 | 54 | 12,386 | 3,680 |
...
- `sol-fast`는 다른 작업 폴더에서 새로 구현한 뒤 결과물만 옮겨 왔다. 파일 생성 시각이 작업 시간이 아니므로 파일 활동 시간은 측정 불가로 둔다. `astra`도 인접 엔진·테스트를 참고한 기록이 있어 완전 독립 구현 비교로 단정하지 않는다.
...
- 11개 프로젝트 합계: **603개 파일, 텍스트 전체 89,169줄, 코드 비공백 38,128줄**.
